...
class UnixFileSystem extends java.io.FileSystem {
    ...
    private java.io.ExpiringCache javaHomePrefixCache = new java.io.ExpiringCache();
    ...
    private native String canonicalize0(String path) throws java.io.IOException;
    ...
    public native int getBooleanAttributes0(java.io.File f);
    ...
    /* -- Disk usage -- */
    public native long getSpace(java.io.File f, int t);
