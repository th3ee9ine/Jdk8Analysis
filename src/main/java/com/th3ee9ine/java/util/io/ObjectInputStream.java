    ...
    extends java.io.InputStream implements ObjectInput, ObjectStreamConstants
{
     ...
     */
    private Object readObject0(Class<?> type, boolean unshared) throws java.io.IOException {
        ...
        throws java.io.IOException
    {
        ...
        try {
            ...
            java.io.IOException ex = new InvalidObjectException("Proxy interface limit exceeded: " +
                    Arrays.toString(ifaces));
            ex.initCause(memerr);
            throw ex;
        }
    ...
    private java.io.IOException readFatalException() throws java.io.IOException {
        ...
        return (java.io.IOException) readObject0(Object.class, false);
    }
